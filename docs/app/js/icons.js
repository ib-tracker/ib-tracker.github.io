/* icons.js — inline SVG icon set (stroke style, lucide-compatible paths) */
(function () {
  "use strict";
  ...
  const P = {
    ...
    alertTri: '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',
    ...
    chartMini: '<line x1="12" x2="12" y1="20" y2="10"/><line x1="18" x2="18" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="16"/>',
  ...
  App.icon = function (name, cls) {
    ...
    // width/height="1em" is a safe default so an icon used in plain text never
    // balloons to its intrinsic size; any CSS rule that sizes it still wins.
    return `<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${cls ? ` class="${cls}"` : ""} aria-hidden="true">${path}</svg>`;
  };
})();
